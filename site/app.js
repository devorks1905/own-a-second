...
de: {
  ...
  auction_title:"Prime-Sekunden — Live-Auktion", auction_sub:"Die seltensten Momente der Uhr. Biete, um sie für immer zu besitzen.", auction_min:"Minimum", auction_current:"Aktuelles Gebot", auction_ends:"Endet", auction_bid_count:"Gebote", auction_no_live:"Gerade keine Live-Auktionen.", auction_place:"Gebot abgeben", auction_your_name:"Dein Name / Handle", auction_amount:"Gebot (USD)", auction_submit:"Bieten", auction_bid_ok:"Gebot abgegeben!", auction_closed:"Diese Auktion ist beendet.", auction_bid_low:"Gebot zu niedrig.", auction_not_found:"Auktion nicht gefunden.", auction_won:"Gewinner", pay_pending:"Zahlung erforderlich", err_auction_only:"Dieser Moment ist eine Prime-Sekunde — biete in der Auktion.", lang_label:"Sprache", footer1:"OWN A SECOND — ein Prototyp. © 2026", footer2:"Jede Sekunde hat eine Nummer. Jede Nummer kann einen Besitzer haben."
},
es: {
...
fr: {
  ...
  auction_title:"Secondes Prime — enchère en direct", auction_sub:"Les moments les plus rares de l'horloge. Enchérissez pour les posséder pour toujours.", auction_min:"Minimum", auction_current:"Enchère actuelle", auction_ends:"Fin", auction_bid_count:"enchères", auction_no_live:"Aucune enchère en direct pour le moment.", auction_place:"Enchérir", auction_your_name:"Votre nom / pseudo", auction_amount:"Montant de l'enchère (USD)", auction_submit:"Enchérir", auction_bid_ok:"Enchère placée !", auction_closed:"Cette enchère est terminée.", auction_bid_low:"Enchère trop basse.", auction_not_found:"Enchère introuvable.", auction_won:"Gagnant", pay_pending:"Paiement requis", err_auction_only:"Ce moment est une Seconde Prime — enchérissez dans la vente.", lang_label:"Langue", footer1:"OWN A SECOND — un prototype. © 2026", footer2:"Chaque seconde a un numéro. Chaque numéro peut avoir un propriétaire."
},
ar: {
...
function renderAll(){
  ...
  renderUpcoming();
  if (lastClaims) renderLedger(lastClaims);
  renderAuctions();
}
...
function connectSSE(){
  ...
  es.onmessage = function(ev){
    ...
    if (msg.type === 'tick') renderClock(msg.unix, msg.current);
    else if (msg.type === 'claim') refreshData();
  };
